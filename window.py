...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(661, 588)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.centralwidget.setObjectName("centralwidget")
        self.toolBox = QtWidgets.QToolBox(self.centralwidget)
        self.toolBox.setGeometry(QtCore.QRect(20, 0, 611, 561))
        self.toolBox.setObjectName("toolBox")
        self.toolBoxPage1 = QtWidgets.QWidget()
        self.toolBoxPage1.setGeometry(QtCore.QRect(0, 0, 611, 507))
        self.toolBoxPage1.setObjectName("toolBoxPage1")
        self.groupBox = QtWidgets.QGroupBox(self.toolBoxPage1)
        self.groupBox.setGeometry(QtCore.QRect(20, 0, 611, 541))
        ...
        self.btnSimulacion.setGeometry(QtCore.QRect(10, 390, 261, 31))
        ...
        self.lineEditDiferencia.setGeometry(QtCore.QRect(410, 390, 111, 31))
        font = QtGui.QFont()
        ...
        self.label_8.setGeometry(QtCore.QRect(290, 396, 121, 21))
        font = QtGui.QFont()
        ...
        self.btnGraficoDePuntos.setGeometry(QtCore.QRect(10, 430, 261, 31))
        self.btnGraficoDePuntos.setObjectName("btnGraficoDePuntos")
        self.btnGraficoDeBarras = QtWidgets.QPushButton(self.groupBox)
        self.btnGraficoDeBarras.setGeometry(QtCore.QRect(10, 470, 261, 31))
        self.btnGraficoDeBarras.setObjectName("btnGraficoDeBarras")
        self.btnReporte = QtWidgets.QPushButton(self.groupBox)
        self.btnReporte.setGeometry(QtCore.QRect(290, 470, 231, 31))
        self.btnReporte.setObjectName("btnReporte")
        self.lineEditCantidadM4 = QtWidgets.QSpinBox(self.groupBox)
        self.lineEditCantidadM4.setGeometry(QtCore.QRect(410, 290, 111, 26))
        self.lineEditCantidadM4.setObjectName("lineEditCantidadM4")
        self.lineEditCantidadM6 = QtWidgets.QSpinBox(self.groupBox)
        self.lineEditCantidadM6.setGeometry(QtCore.QRect(410, 320, 111, 26))
        self.lineEditCantidadM6.setObjectName("lineEditCantidadM6")
        self.label_9 = QtWidgets.QLabel(self.groupBox)
        self.label_9.setGeometry(QtCore.QRect(10, 290, 311, 17))
        self.label_9.setObjectName("label_9")
        self.label_10 = QtWidgets.QLabel(self.groupBox)
        self.label_10.setGeometry(QtCore.QRect(10, 320, 311, 17))
        self.label_10.setObjectName("label_10")
        self.line_3 = QtWidgets.QFrame(self.toolBoxPage1)
        self.line_3.setGeometry(QtCore.QRect(30, 370, 521, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "Cantidad de pedidos M4 (poisson):"))
        self.label_10.setText(_translate("MainWindow", "Cantidad de pedidos M6 (poisson):"))
